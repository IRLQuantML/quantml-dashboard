...
PREFER_STACKED_IF_AVAILABLE   = True     # let data decide; stacked underperformed in Sharpe on avg.

# === Recommended defaults (based on V2 + V1full results) ===

# Ensemble thresholds & confidence
ENSEMBLE_LONG_THRESHOLD  = 0.50
ENSEMBLE_SHORT_THRESHOLD = 0.50
MIN_CONF_FLOOR           = 0.10
ENSEMBLE_TEMP            = 1.0
