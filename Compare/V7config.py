...
DISAGREE_STD_CUTOFF = 0.15               # std-dev of family P(LONG) across models
DISAGREE_CONF_LIFT = 0.05                # require this extra confidence when high disagreement
...
# === Recommended defaults (based on V2 + V1full results) ===

# Ensemble thresholds & confidence
ENSEMBLE_LONG_THRESHOLD  = 0.56
ENSEMBLE_SHORT_THRESHOLD = 0.56
MIN_CONF_FLOOR           = 0.56
ENSEMBLE_TEMP            = 1.0
...
# Margin (decisiveness) filter
xgb_prob_diff_quantile = 0.064   # consider 0.10 if you need more capacity
...
max_open_trades = 9
PORTFOLIO_K_MAX = 15
EV_MAX_WEIGHT_PER_NAME = 0.25
PORTFOLIO_MAX_WEIGHT   = 0.33

# Ensemble weighting (balanced)
ENSEMBLE_WEIGHTS = {
    "XGBoost":            0.28,   # was 0.25
    "LightGBM":           0.24,   # was 0.22
    "CatBoost":           0.23,   # was 0.22
    "RandomForest":       0.14,   # was 0.16
    "LogisticRegression": 0.11,   # was 0.15
}
ENSEMBLE_WEIGHT_CAP_PER_FAMILY = 0.75
