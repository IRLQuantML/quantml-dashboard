...
BACKTEST_BASE    = False   # new: skip per-family base runs
BACKTEST_STACKED = False   # already present; keep False to skip stacked
BACKTEST_MODE = "ensemble_only"   # "full" | "ensemble_only" | "base_only" | "stacked_only"
WRITE_TRADES = False
WRITE_FUNNELS = False

# === Ensemble thresholds & confidence (latest best) ===
ENSEMBLE_LONG_THRESHOLD  = 0.54915
ENSEMBLE_SHORT_THRESHOLD = 0.49592
ENSEMBLE_TEMP            = 0.9000
MIN_CONF_FLOOR           = 0.52899
...
APPLY_EMA_BUFFER     = True
ema_buffer_pct_long  = 1.00599
ema_buffer_pct_short = 1.00422

APPLY_MACD      = True
macd_hist_long  = 0.06931
macd_hist_short = 0.04302

# Tail gate disabled
xgb_prob_diff_quantile = None

# === Exits / trailing / risk ===
atr_sl_multiplier = 0.7000
atr_tp_multiplier = 1.4670
TRAIL_ATR_MULT    = 1.55345
RISK_PER_TRADE    = 0.01963

# === Volume gate ===
volume_min        = 80_000     # round to a clean, liquid floor
volume_buffer_pct = 0.10
...
ENSEMBLE_WEIGHTS = {
    "RandomForest":        0.20985,
    "LightGBM":            0.18256,
    "XGBoost":             0.20838,
    "CatBoost":            0.21209,
    "LogisticRegression":  0.18712,
}
